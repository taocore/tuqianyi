...
//		_log.info("fixed: " + label.getText());
		try
		{
			BufferedImage image = FontProvider.getInstance().createText(label.getText(), label.getFont(), label.getColor(), label.getBackground(), label.getStyle(), label.getLine(), label.getBorderWidth(), label.getAngle());
